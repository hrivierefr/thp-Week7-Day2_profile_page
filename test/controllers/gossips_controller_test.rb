...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { create: @gossip.create, delete: @gossip.delete, edit: @gossip.edit, index: @gossip.index, new: @gossip.new, show: @gossip.show, update: @gossip.update } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { create: @gossip.create, delete: @gossip.delete, edit: @gossip.edit, index: @gossip.index, new: @gossip.new, show: @gossip.show, update: @gossip.update } }
